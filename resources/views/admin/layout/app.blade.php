                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        class="nav-link {{ Request::routeIs('project/create') ? 'active' : '' }}" >
                                            <i class="fa fa-angle-double-right"></i>
                                            <p>New Project</p>
                                        </a>
                                    </li>
                                    @endif
                                    <li class="nav-item">
                                        <a href="{{route('project/archive')}}" 
                                        class="nav-link {{ Request::routeIs('project/archive') ? 'active' : '' }}" >
                                            <i class="fa fa-angle-double-right"></i>
                                            <p>Archive</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        class="nav-link {{ Request::routeIs('task/create') ? 'active' : '' }}" >
                                        <i class="fa fa-angle-double-right"></i>
                                        <p>New Task</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        class="nav-link {{ Request::routeIs('task/archive') ? 'active' : '' }}" >
                                        <i class="fa fa-angle-double-right"></i>
                                        <p>Archive</p>
                                        </a>
                                    </li>
                    ...
                    <div class="row mb-2">
                        ...
                        {{-- <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item {{ Request::routeIs('home') ? 'active' : '' }}"><a href="{{route('home')}}">Home</a></li>
